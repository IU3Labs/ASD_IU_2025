 ...
 *
 * 1) Добавление элементов:
 * Очередь (от начала к концу): 7 9 2 4
 * Очередь (от конца к началу): 4 2 9 7
 * start: 0  end: 4  size: 4
 * Массив: [7, 9, 2, 4, 0]
 *
 * Добавление '3' в начало
 * Очередь (от начала к концу): 3 7 9 2 4
 * Очередь (от конца к началу): 4 2 9 7 3
 * start: 4  end: 4  size: 5
 * Массив: [7, 9, 2, 4, 3]
 *
 * Добавление '6' в середину
 * Очередь (от начала к концу): 3 7 6 9 2
 * Очередь (от конца к началу): 2 9 6 7 3
 * start: 4  end: 0  size: 5
 * Массив: [7, 6, 9, 2, 3]
 *
 * 2) Удаление с начала: 3
 * Очередь (от начала к концу): 7 6 9 2
 * Очередь (от конца к началу): 2 9 6 7
 * start: 0  end: 0  size: 4
 * Массив: [7, 6, 9, 2, 3]
 *
 * Удаление с конца: 3
 * Очередь (от начала к концу): 7 6 9
 * Очередь (от конца к началу): 9 6 7
 * start: 0  end: 4  size: 3
 * Массив: [7, 6, 9, 2, 3]
 *
 * Удаление из середины: 6
 * Очередь (от начала к концу): 7 9
 * Очередь (от конца к началу): 9 7
 * start: 0  end: 3  size: 2
 * Массив: [7, 9, 9, 2, 3]
 *
 * 3) Проверка цикличности:
 * Очередь (от начала к концу): 7 9 9 10
 * Очередь (от конца к началу): 10 9 9 7
 * start: 0  end: 0  size: 4
 * Массив: [7, 9, 9, 10, 100]
 */